// defaults.ts — seed categories + rules (first-run only). Once Koin saves an edited
...
export const DEFAULT_RULES: RuleSet = {
  // Generic starter rules using well-known brands + common keywords. Add your own (or just
  // categorize a transaction in the UI — that learns a rule automatically).
  ignorePatterns: [
